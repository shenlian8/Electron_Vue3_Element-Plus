...
function startRequest() {
  console.log(obj.value.message);
  window.api.send("toMain", obj.value.message);
};

window.api.receive("fromMain", (data) => {
    console.log(data);
    obj.value.message = data
});

window.api.receive("networkError", (data) => {
    console.log(data);
});
</script>
...
<template>
  ...
  <el-button @click="startRequest" type="success">You've successfully created an Electron project with Vue and Element Plus, {{obj.message}}!</el-button>
